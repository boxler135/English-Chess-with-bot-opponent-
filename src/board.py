...
class Board:
    ...
    # for any move, check every enemy piece see if will check king to disallow
    def in_check(
            self,
            piece,
            move
            ...
            for possible_move_col in possible_move_cols:
                if Square.in_range(possible_move_row, possible_move_col):
                    if self.squares[possible_move_row][
                        ...
                        # create initial and final move squares
                        initial = Square(row, col)
                        final_piece = self.squares[
                            possible_move_row][possible_move_col].piece
            ...
            if not piece.moved:
                ...
                if isinstance(left_rook, Rook):
                    if not left_rook.moved:
                        for c in range(1, 4):
                            # got pieces in btw rook and king
                            ...
                            if c == 3:
                                ...
                                if bool:
                                    if not self.in_check(
                                        piece,moveK) and not self.in_check(
                                            left_rook, moveR):
